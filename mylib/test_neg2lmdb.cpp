...
// jin: 2016-02-18 11:48:17 difference from convert_NoFace_MySpace.cpp: the input img_name of function load_candidates has suffix, so use substr to deal with it.
...
// jin: 2016-02-24 10:49:40  remove %8d in keystr 
// basic steps:
...
int  load_key_rect(const char *keylist, vector<string> &strlist, vector<CNN_RECT> &vcr)
{  
	ifstream infile(keylist);
	if(!infile)
	{
...
int main(int argc, char** argv) {
	...
	//char *keylist[] = {"building/0964.jpg_222_654_64_64", 
	//				  "forest/0176.jpg_317_684_30_30",
	//				  "MySpace/04/l_52a1500cb40686cae3621a9512b48d37.jpg_86_126_75_75",
	//				  "MySpace/02/l_1a55346f2e8520d4d66530084ed882aa.jpg_357_441_27_27",
	//				  "graphic/0060.jpg_619_813_371_371"};
	//	int total_num = sizeof(keylist) / sizeof(keylist[0]);
	//	printf("total_num = %d\n", total_num);
	//for(int i=0; i<total_num; ++i)
	//{
	//	string img_name = keylist[i];
	//	img_name = rootpath + keylist[i]
	//}
	
	
	const char *keylist = "invalid_keylist.txt";
	string rootpath("/mnt/z/User/team02/Face_DB/NoFace/image");
	...
	while(db >> keystr >> rect.x >> rect.y >> rect.w >> rect.h) 
	{
		vs.push_back(keystr);
		vr.push_back(rect);
	}
